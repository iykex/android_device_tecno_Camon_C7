...
BOARD_HARDWARE_CLASS += device/tecno/Camon_C7/cmhw
...
#TARGET_KERNEL_CONFIG := Camon_C7_defconfig
...
#endif
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board C7-ZC6X
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Camon_C7,TECNO-C7,tecno,C7,Camon-C7,tecno
